...
class SuperAxios {
    constructor(config) {
        ...
        const { queue = new Map(), maxReconnectTimes = 5, delayTime = 300, reconnectTime = 1500 } = config;
        this.queue = queue;
    ...
    cancel(r) {
        ...
        const hashcode = this.getHashCode(r);
        if (this.checkRequestExists(hashcode)) {
            (_b = (_a = this.queue.get(hashcode)) === null || _a === void 0 ? void 0 : _a.cancelHandle) === null || _b === void 0 ? void 0 : _b.call(_a, "取消上一次相同请求");
