...
var AxiosManager = /** @class */ (function () {
    ...
    function AxiosManager(axiosConfig, _a) {
        var _this = this;
        var _b = _a.maxReconnectionTimes, maxReconnectionTimes = _b === void 0 ? 5 : _b, _c = _a.timeStep, timeStep = _c === void 0 ? 1000 : _c, _d = _a.tryBegin, tryBegin = _d === void 0 ? function () {
        } : _d, _e = _a.tryFail, tryFail = _e === void 0 ? function () {
        } : _e, _f = _a.trySuccess, trySuccess = _f === void 0 ? function () {
        } : _f;
        this.cancelMap = new Map(); // 请求队列
        this.shakeMap = new Map(); // 防抖的请求队列
        this.tryingMap = new Map(); // 重连队列
        this.timeStep = 1000; // 断线重连时间间隔
        this.maxReconnectionTimes = 5; // 最大重连数
        this.delayTime = 500; // 延时时间
        ...
        this.Http.interceptors.response.use(function (res) {
            ...
            if (error.message.search('timeout') > -1) {
                ...
                if (request) {
                    if (request.autoCounts && maxReconnectionTimes_1 > request.autoCounts) {
                        request.autoCounts++;
                        _this.tryingMap.set(_this.getKey(url_1, method_1), request);
    ...
    AxiosManager.prototype.dispatch = function (context) {
        ...
        return __awaiter(this, void 0, Promise, function () {
            var url, method, data, params, headers, delayTime, delay, shake, needCancel, _b, shakeMap, cancelMap, it, res, e_1;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        _b = this, shakeMap = _b.shakeMap, cancelMap = _b.cancelMap;
                        // 是否需要取消上一次的请求
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, this.Http({
                                ...
                                data: data,
                                params: params,
                                headers: __assign(__assign({}, this.Http.defaults.headers), headers)
                            })];
                    case 4:
                        res = _c.sent();
    ...
    AxiosManager.prototype.getKey = function (url, method) {
        return "url=".concat(url, "method=").concat(method);
    };
    return AxiosManager;
}());
...
module.exports = JSON.parse('{"_from":"axios@^0.21.1","_id":"axios@0.21.4","_inBundle":false,"_integrity":"sha512-ut5vewkiu8jjGBdqpM44XxjuCjq9LAKeHVmoVfHVzy8eHgxxq8SbAVQNovDA8mVi05kP0Ea/n/UzcSHcTJQfNg==","_location":"/axios","_phantomChildren":{},"_requested":{"type":"range","registry":true,"raw":"axios@^0.21.1","name":"axios","escapedName":"axios","rawSpec":"^0.21.1","saveSpec":null,"fetchSpec":"^0.21.1"},"_requiredBy":["/"],"_resolved":"https://registry.npmjs.org/axios/-/axios-0.21.4.tgz","_shasum":"c67b90dc0568e5c1cf2b0b858c43ba28e2eda575","_spec":"axios@^0.21.1","_where":"/Users/anguodong/Desktop/super-axios","author":{"name":"Matt Zabriskie"},"browser":{"./lib/adapters/http.js":"./lib/adapters/xhr.js"},"bugs":{"url":"https://github.com/axios/axios/issues"},"bundleDependencies":false,"bundlesize":[{"path":"./dist/axios.min.js","threshold":"5kB"}],"dependencies":{"follow-redirects":"^1.14.0"},"deprecated":false,"description":"Promise based HTTP client for the browser and node.js","devDependencies":{"coveralls":"^3.0.0","es6-promise":"^4.2.4","grunt":"^1.3.0","grunt-banner":"^0.6.0","grunt-cli":"^1.2.0","grunt-contrib-clean":"^1.1.0","grunt-contrib-watch":"^1.0.0","grunt-eslint":"^23.0.0","grunt-karma":"^4.0.0","grunt-mocha-test":"^0.13.3","grunt-ts":"^6.0.0-beta.19","grunt-webpack":"^4.0.2","istanbul-instrumenter-loader":"^1.0.0","jasmine-core":"^2.4.1","karma":"^6.3.2","karma-chrome-launcher":"^3.1.0","karma-firefox-launcher":"^2.1.0","karma-jasmine":"^1.1.1","karma-jasmine-ajax":"^0.1.13","karma-safari-launcher":"^1.0.0","karma-sauce-launcher":"^4.3.6","karma-sinon":"^1.0.5","karma-sourcemap-loader":"^0.3.8","karma-webpack":"^4.0.2","load-grunt-tasks":"^3.5.2","minimist":"^1.2.0","mocha":"^8.2.1","sinon":"^4.5.0","terser-webpack-plugin":"^4.2.3","typescript":"^4.0.5","url-search-params":"^0.10.0","webpack":"^4.44.2","webpack-dev-server":"^3.11.0"},"homepage":"https://axios-http.com","jsdelivr":"dist/axios.min.js","keywords":["xhr","http","ajax","promise","node"],"license":"MIT","main":"index.js","name":"axios","repository":{"type":"git","url":"git+https://github.com/axios/axios.git"},"scripts":{"build":"NODE_ENV=production grunt build","coveralls":"cat coverage/lcov.info | ./node_modules/coveralls/bin/coveralls.js","examples":"node ./examples/server.js","fix":"eslint --fix lib/**/*.js","postversion":"git push && git push --tags","preversion":"npm test","start":"node ./sandbox/server.js","test":"grunt test","version":"npm run build && grunt version && git add -A dist && git add CHANGELOG.md bower.json package.json"},"typings":"./index.d.ts","unpkg":"dist/axios.min.js","version":"0.21.4"}');
